  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const userResponse = await fetch('https://crazycar-kxb4.onrender.com/api/users/count');
        ...
        const carResponse = await fetch('https://crazycar-kxb4.onrender.com/api/cars/count');
