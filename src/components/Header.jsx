    ...
    const checkAdminStatus = async () => {
        try {
            //const response = await fetch('http://localhost:5000/admin/check', {
                const response = await fetch('https://crazycar-kxb4.onrender.com/admin/check', {
                method: 'GET',
                credentials: 'include',
            });
            if (response.ok) {
        ...
        if (userId) {
            const fetchUserName = async () => {
                try {
                    ...
                    const response = await fetch(`https://crazycar-kxb4.onrender.com/user/${userId}`);
    ...
    const handlerLogout = async () => {
        try {
            //await fetch('http://localhost:5000/logout', {
                await fetch('https://crazycar-kxb4.onrender.com/logout', {
                method: 'GET',
                credentials: 'include',
            });
